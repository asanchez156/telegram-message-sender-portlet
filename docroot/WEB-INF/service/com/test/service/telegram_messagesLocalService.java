...
/**
 * Provides the local service interface for telegram_messages. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author asanchez
 * @see telegram_messagesLocalServiceUtil
...
public interface telegram_messagesLocalService extends BaseLocalService,
	InvokableLocalService, PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link telegram_messagesLocalServiceUtil} to access the telegram_messages local service. Add custom service methods to {@link com.test.service.impl.telegram_messagesLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
