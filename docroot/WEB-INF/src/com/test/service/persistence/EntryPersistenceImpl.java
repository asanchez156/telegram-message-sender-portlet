...
import com.test.NoSuchEntryException;

import com.test.model.Entry;
import com.test.model.impl.EntryImpl;
import com.test.model.impl.EntryModelImpl;
...
public class EntryPersistenceImpl extends BasePersistenceImpl<Entry>
	 ...
	 */
	@Override
	public Entry create(long tm_Id) {
		Entry entry = new EntryImpl();

		entry.setNew(true);
		entry.setPrimaryKey(tm_Id);
	 ...
	 */
	@Override
	public Entry remove(long tm_Id)
		throws NoSuchEntryException, SystemException {
		return remove((Serializable)tm_Id);
	}
	...
	@Override
	public Entry updateImpl(com.test.model.Entry entry)
	...
	protected Entry toUnwrappedModel(Entry entry) {
		...
		entryImpl.setTm_Id(entry.getTm_Id());
		entryImpl.setUser(entry.getUser());
		entryImpl.setMessage(entry.getMessage());
		entryImpl.setDate(entry.getDate());
	 ...
	 */
	@Override
	public Entry findByPrimaryKey(long tm_Id)
		throws NoSuchEntryException, SystemException {
		return findByPrimaryKey((Serializable)tm_Id);
	}
	 ...
	 */
	@Override
	public Entry fetchByPrimaryKey(long tm_Id) throws SystemException {
		return fetchByPrimaryKey((Serializable)tm_Id);
	}
	...
	public void afterPropertiesSet() {
		String[] listenerClassNames = StringUtil.split(GetterUtil.getString(
					com.liferay.util.service.ServiceProps.get(
						"value.object.listener.com.test.model.Entry")));
